    ...
    try {
        ...
        if (themes.length === 0) {
            const defaultThemes = [
                ...
                { id: 'vehicles', displayName: 'Vehicles', previewImageUrl: null, cardImageUrls: [] },
                { id: 'flags', displayName: 'Flags', previewImageUrl: null, cardImageUrls: [] },
                ...
                { id: 'instruments', displayName: 'Musical Instruments', previewImageUrl: null, cardImageUrls: [] }
            ];
